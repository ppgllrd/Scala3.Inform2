...
object Arc: 
   ...
   * @param alpha starting angle of the arc in radians.
   * @param beta angular extent of the arc in rqdians.
   * @param kind type of arc: OPEN, CHORD or PIE.
   * @return a new arc constructed from specified parameters.
   */
